...
```
    ...
    need.  Members $$$PROSE (PDS 7.3) and $$$PROS2 (PDS 8.6) give good
    examples of battle maneuvers.  For a map of all paths through PDS,
    the PDSHELP member is your key; to create a copy of the HELP to
    carry with you, use the HELPLIST program.  ISPF tutorial and
    selection panels are close at hand for use in the heat of battle.
