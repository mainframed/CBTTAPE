...
//* *==================================================================*
//* ********************************************************************
//* * Created   by :Kang Dengsong(ES9000@126.COM)                      *
//* * Created date :Dec 11, 2008                                       *
//* * Remark       :Readme document                                    *
//* ********************************************************************
//* *==================================================================*
...
//* * in his own system.                                               *
//*====================================================================*
//* Compents   Type     Description                                    *
//* ********* ********* ************************************************
//* $README    Document                                                *
//* $SMF30EX   JCL      Sample job                                     *
//* SMF30CPX   Copybook                                                *
//* SMF30CPY   Copybook                                                *
//* SMF30CRP   Copybook                                                *
//* SMF30EX1   Source   Generate work file from SMF files              *
//*                     (Only extract SMF type 30 record)              *
//* SMF30EX2   Source   Generate Report for full                       *
//* SMF30EX3   Source   Generate Report for simple(sort by cost time)  *
//* LOADXMIT   Loadlib  XMIT format(PlS user receive it)               *
//*====================================================================*
```
