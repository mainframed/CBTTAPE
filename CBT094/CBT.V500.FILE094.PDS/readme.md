...
Ý    ¨    Step 1  -  Validate SMF subsystem integrity

Ý    ¨    Step 2  -  Upload product distribution files

Ý    ¨    Step 3  -  Process the object module with the linkage
editor

Ý    ¨    Step 4  -  Integrate DAF into the environment

Ý    ¨    Step 5  -  Install SMF job initiation exit IEFUJI
(optional)
...
Ý    ¨    Step 1  -  Determine which SMF data to use

Ý    ¨    Step 2  -  Determine which control statements to use

Ý    ¨    Step 3  -  Use DAF.EXE to generate control statements,
JCL and submit JOB

Ý    ¨    Step 4  -  Review system output

Ý    ¨    Step 5  -  Repeat steps 1 through 4 until the desired
